class MainPagesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @main_page.save
        format.html { redirect_to main_page_url(@main_page), notice: "Main page was successfully created." }
  ...
  def update
    respond_to do |format|
      if @main_page.update(main_page_params)
        format.html { redirect_to main_page_url(@main_page), notice: "Main page was successfully updated." }
